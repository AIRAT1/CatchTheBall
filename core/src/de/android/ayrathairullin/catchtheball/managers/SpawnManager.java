...
public class SpawnManager {
    private static final float BALL_RESIZE_FACTOR = 2500;

    static float delayTime = .8f;
    ...
    public static Ball resetBall(Ball ball) {
        ball.ballSprite.setSize(ball.ballSprite.getTexture().getWidth() * (width / BALL_RESIZE_FACTOR),
                ball.ballSprite.getTexture().getHeight() * (width / BALL_RESIZE_FACTOR));
